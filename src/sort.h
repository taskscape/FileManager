...
// CAUTION: sort-codes in RefreshDirectory, ChangeSortType and CompareDirectories must correspond!!!
...
// NULL) returns TRUE if strings are numerically equal (e.g. "a01" and "a1")
