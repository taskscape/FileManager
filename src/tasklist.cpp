...
// therefore I'm changing the following constants "Taskscape LtdSalamander*" -> "Taskscape LtdSalamander3*", so we are separated from older versions

// WARNING: when changing, salbreak.exe needs to be modified, just send me the info please ... thanks, Petr

const char* AS_PROCESSLIST_NAME = "Taskscape LtdSalamander3bProcessList";                               // shared memory CProcessList
const char* AS_PROCESSLIST_MUTEX_NAME = "Taskscape LtdSalamander3bProcessListMutex";                    // synchronization for access to shared memory
const char* AS_PROCESSLIST_EVENT_NAME = "Taskscape LtdSalamander3bProcessListEvent";                    // triggering event (what should be done is stored in shared memory)
const char* AS_PROCESSLIST_EVENT_PROCESSED_NAME = "Taskscape LtdSalamander3bProcessListEventProcessed"; // triggered event was processed

const char* FIRST_SALAMANDER_MUTEX_NAME = "Taskscape LtdSalamanderFirstInstance";     // introduced from AS 2.52 beta 1
const char* LOADSAVE_REGISTRY_MUTEX_NAME = "Taskscape LtdSalamanderLoadSaveRegistry"; // introduced from AS 2.52 beta 1
