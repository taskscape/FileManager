...
static THREAD_FUNC_DECL HashThreadFunc2WithSalamanderStack(void *p)
{
...
static THREAD_FUNC_DECL BtThreadFunc2WithSalamanderStack(void *p)
{
    ...
    UInt32 matchMaxLen, UInt32 keepAddBufferAfter, ISzAllocPtr alloc)
{
  ...
  RINOK(MtSync_Create(&p->hashSync, HashThreadFunc2WithSalamanderStack, p))
  RINOK(MtSync_Create(&p->btSync, BtThreadFunc2WithSalamanderStack, p))
  return SZ_OK;
}
