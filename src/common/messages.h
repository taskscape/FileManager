...
// ANSI helper that formats and shows message boxes used by the MESSAGExx macros.
class C__Messages
{
protected:
...
// Unicode helper that formats and shows message boxes used by the MESSAGExx macros.
class C__MessagesW
{
protected:
