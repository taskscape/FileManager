...
// LoadLibraryPathW for Release mode (when HANDLES_ENABLE is not defined)
inline HINSTANCE LoadLibraryPathW(LPCWSTR wideLibFileName)
{
    HINSTANCE ret = NULL;
...
public:
    ...
    HINSTANCE LoadLibraryPathW(LPCWSTR wideLibFileName);
